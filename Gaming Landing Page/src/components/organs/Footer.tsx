    ...
    return (
        <footer className="w-full flex flex-col bg-white">
                            ...
                            FooterTexts.contacts.links.map((link, index) => (
                                <List key={index} className="text-sm">
                                    <Link to={link.url} className="text-color4 transition-all duration-300 hover:underline">
                                        {link.name}
                                        {link.name=='WhatsApp'&& <WhatsappLogo size={15} color="currentColor" weight="fill" />}
                                        {link.name=='Email'&& <WhatsappLogo size={15} color="currentColor" weight="fill" />}
                                    </Link>
                                </List>
                            ))
                        }
            ...
            <Text className="text-center bg-color4 text-white text-xs py-6 font-light">
                Copyright 2023. boss-gaming.com. All rights reserved.
            </Text>
        </footer>
    )
}
